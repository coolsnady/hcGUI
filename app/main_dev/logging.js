...
// format compatible to hxd/dcrwallet logs. This function is meant to be
...
export const AddToHxdLog = (destIO, data, debug) => {
  hxdLogs = AddToLog(destIO, hxdLogs, data, debug);
};
...
export const GetHxdLogs = () => hxdLogs;
