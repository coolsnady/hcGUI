...
export function hxdCfg(configPath) {
...
export function getHxdRpcCert (appDataPath) {
  return path.resolve(appDataPath ? appDataPath : getHxdPath(), "rpc.cert");
}
