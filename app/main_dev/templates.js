...
import { cleanShutdown, GetHxdPID, GetDcrwPID, readExesVersion } from "./launch";
import { getDirectoryLogs, getDcrwalletPath, getHxdPath } from "./paths";
...
const defaultTemplate = (mainWindow, locale) => [ {
  ...
  submenu: [ {
    ...
    click() {
      shell.openItem(getDirectoryLogs(getHxdPath()));
    }
  } ]
}, {
