...
export const getHxdLogs = log(() => Promise
  .resolve(ipcRenderer.sendSync("get-hxd-logs"))
  .then(logs => {
    if (logs) return logs;
...
export const getHxdLastLogLine = () => Promise
  .resolve(ipcRenderer.sendSync("get-last-log-line-hxd"));
