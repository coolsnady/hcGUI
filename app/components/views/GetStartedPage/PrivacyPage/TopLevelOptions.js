  ...
  <Aux>
    ...
    <div className="privacy-options">
      ...
      <PrivacyOption
        ...
        icon="disabled"
        description={<T id="privacy.options.disabled.description" m="Disables all connections to third party (non-hxd/non-dcrwallet) services. This may prevent you from using certain features of the app. Recommended for advanced users." />}
